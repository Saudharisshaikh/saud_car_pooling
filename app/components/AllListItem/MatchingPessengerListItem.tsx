...
export default function MatchingPessengerListItem({onClick,buttonText,highlightButtonText,isHighlight}: any) {
  ...
  return (
    <View style={{flex:1}}>
         <View
          ...
          <View
            style={isHighlight?styles.highlighTrue:styles.highlighFalse}>

              {isHighlight&&(<HighlightButton
              title={highlightButtonText || 'Select'}
              onPress={() => {
